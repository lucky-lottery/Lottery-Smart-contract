...
contract Lottery is Ownable, Initializable, Testable {
    ...
    // State variables 
    // Instance of Busd token (collateral currency for lotto)
    IERC20 internal busd_;
    // Storing of the NFT
    ...
    function claimReward(uint256 _lotteryId, uint256 _tokenId) external notContract() {
        ...
        busd_.safeTransfer(address(msg.sender), prizeAmount);
    }
    ...
    function batchClaimRewards(
        ...
        busd_.safeTransfer(address(msg.sender), totalPrize);
    }
