...
contract LotteryToken is Context, IERC20, Ownable, Pausable {
    ...
    constructor () {
        ...
        uint256 amount =  BASE_MINT*50; //50m
        _totalSupply = amount;
        uint256 _max = MAX.div(1e12);
    ...
    function registerAirdropDistribution() public onlyOwner {
        ...
        uint256 _currentRate = _getRate();
        _totalSupply = _totalSupply.add(AIRDROP_AMOUNT);
